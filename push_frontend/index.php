                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--orange">
                                <h2 class="number"><?php echo $query; ?></h2>
                            ...
                            <div class="table-data__tool">
                                ...
                                <div class="table-data__tool-right">
                                    ...
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        <i class="zmdi zmdi-plus"></i>Create Post</button>
                                    </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                                        <tr class="tr-shadow">
                                            <td></td>
                                            <td>
                                                <span class="block-email">1</span>
                                            </td>
                                            <td class="desc">This is a post</td>
                                            <td>
                                        ...
                                        <tr class="tr-shadow">
                                            <td></td>
                                            <td>
                                                <span class="block-email">2</span>
                                            </td>
                                            <td class="desc">Samsung S8 Black and i want an iPhone Xs</td>
                                            <td>
                                                <span class="status--process">True</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="tr-shadow">
                                            <td></td>
                                            <td>
                                                <span class="block-email">3</span>
                                            </td>
                                            <td class="desc">Samsung S8 Black</td>
                                            <td>
                                                <span class="status--denied">False</span>
                                            </td>
                                            <td>
                                                <div class="table-data-feature">
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Send">
